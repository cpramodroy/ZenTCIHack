...
public class UpdateTicketAdvancedSection extends AbstractBWTransactionalSection 
{
	...
	*/
    ...
    private AttributeBindingField attachmentNameABF;
    ...
    protected Composite doCreateControl(final Composite root) {
        ...
        // begin-custom-code
   	    attachmentNameABF = BWFieldFactory.getInstance().createAttributeBindingField(parent, attachmentName, PropertyTypeQnameConstants.STRING_PRIMITIVE, true);
   	    attachmentNameABF.setDefaultPropertyPrefix("File Name");
