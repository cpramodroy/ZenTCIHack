 ...
 */
public class GetTicketsGeneralSection extends AbstractBWTransactionalSection {
   /**
	* <!-- begin-custom-doc -->
	* 
	* <!-- end-custom-doc -->
	...
	*/
    ...
    protected void initBindings() {
        getBindingManager().bind(companyUrlABF, getInput(), ZendeskPackage.Literals.GET_TICKETS__COMPANY_URL); 
        getBindingManager().bind(userIdABF, getInput(), ZendeskPackage.Literals.GET_TICKETS__USER_ID); 
        getBindingManager().bind(passwordABF, getInput(), ZendeskPackage.Literals.GET_TICKETS__PASSWORD); 
   	    // begin-custom-code
        // end-custom-code
    }
    ...
    protected Composite doCreateControl(final Composite root) {
        Composite parent = BWFieldFactory.getInstance().createComposite(root, 2);
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.GETTICKETS_COMPANYURL, true);
   	    ...
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.GETTICKETS_USERID, true);
   	    ...
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.GETTICKETS_PASSWORD, true);
