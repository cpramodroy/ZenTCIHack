 ...
 * 
 */
public class GetTicketMetricsSignature extends BWActivitySignature 
{
	...
	*/
    ...
    public XSDElementDeclaration getInputType(final Configuration config) {
        ...
        inputType =  GetTicketMetricsSchema.getInputType(); 
        // begin-custom-code
        // end-custom-code
        return inputType;
    } 
	...
	*/
    ...
    public XSDElementDeclaration getOutputType(final Configuration config) {
        ...
        outPutType =  GetTicketMetricsSchema.getOutputType();
        // begin-custom-code
        // end-custom-code
        return outPutType;
    }
