 ...
 */
public class CreateTicketGeneralSection extends AbstractBWTransactionalSection 
{
   /**
	* <!-- begin-custom-doc -->
	* 
	...
	*/
    ...
    protected void initBindings() {
        getBindingManager().bind(companyUrlABF, getInput(), ZendeskPackage.Literals.CREATE_TICKET__COMPANY_URL); 
        getBindingManager().bind(userIdABF, getInput(), ZendeskPackage.Literals.CREATE_TICKET__USER_ID); 
        getBindingManager().bind(passwordABF, getInput(), ZendeskPackage.Literals.CREATE_TICKET__PASSWORD); 
   	    // begin-custom-code
        // end-custom-code
    }
    ...
    protected Composite doCreateControl(final Composite root) {
        Composite parent = BWFieldFactory.getInstance().createComposite(root, 2);
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.CREATETICKET_COMPANYURL, true);
   	    ...
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.CREATETICKET_USERID, true);
   	    ...
   	    BWFieldFactory.getInstance().createLabel(parent, Messages.CREATETICKET_PASSWORD, true);
