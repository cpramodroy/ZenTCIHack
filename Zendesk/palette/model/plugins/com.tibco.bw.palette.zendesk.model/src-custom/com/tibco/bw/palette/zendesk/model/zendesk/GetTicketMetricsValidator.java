...
public class GetTicketMetricsValidator implements ActivityConfigurationValidator {	
	/**
	 * <!-- begin-custom-doc -->
	 * 
	 * <!-- end-custom-doc -->
	...
	public void validateBWActivityConfiguration(ActivityValidationContext context) {
	    GetTicketMetrics model =(GetTicketMetrics) context.getActivityConfigurationModel();    	
		...
		if(passwordModul == null || "".equals(passwordModul)){
		    ...
		    if(password == null || "".equals(password)) {
		        ...
		        context.createError(message, null, MessageCode.PARAMETER_NOT_SPECIFIED, ZendeskPackage.Literals.GET_TICKET_METRICS__PASSWORD);
		    }
		}
		...
		if(companyUrlModul == null || "".equals(companyUrlModul)){
		    ...
		    if(companyUrl == null || "".equals(companyUrl)) {
		        ...
		        context.createError(message, null, MessageCode.PARAMETER_NOT_SPECIFIED, ZendeskPackage.Literals.GET_TICKET_METRICS__COMPANY_URL);
		    }
		}
		...
		if(userIdModul == null || "".equals(userIdModul)){
		    ...
		    if(userId == null || "".equals(userId)) {
		        ...
		        context.createError(message, null, MessageCode.PARAMETER_NOT_SPECIFIED, ZendeskPackage.Literals.GET_TICKET_METRICS__USER_ID);
		    }
		}	
		// begin-custom-code
	    // end-custom-code
