...
@XmlType(name = "ActivityInputType", namespace = "http://www.example.org/Search", propOrder = {
    "query"
})
public class ActivityInputType {

    @XmlElement(name = "Query", namespace = "http://www.example.org/Search", required = true)
