...
@XmlType(name = "ActivityOutputType", namespace = "http://www.example.org/DeleteObject", propOrder = {
    "success"
})
public class ActivityOutputType {

    @XmlElement(name = "Success", namespace = "http://www.example.org/DeleteObject")
