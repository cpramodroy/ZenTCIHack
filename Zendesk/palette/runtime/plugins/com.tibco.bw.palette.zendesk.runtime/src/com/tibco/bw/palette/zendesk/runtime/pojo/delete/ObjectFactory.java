 ...
 * generated in the com.tibco.bw.palette.zendesk.runtime.pojo.delete package. 
...
public class ObjectFactory {
    ...
    private final static QName _ActvityInput_QNAME = new QName("http://www.example.org/DeleteObject", "ActvityInput");
    private final static QName _ActivityOutput_QNAME = new QName("http://www.example.org/DeleteObject", "ActivityOutput");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tibco.bw.palette.zendesk.runtime.pojo.delete
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/DeleteObject", name = "ActvityInput")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/DeleteObject", name = "ActivityOutput")
